...
public class DefaultValidateImageCodeGenerator implements ValidateCodeGenerator {
    ...
    public ImageCode createCode() {
        ...
        String sRand = "";
        int length = shieldSecurityProperties.getValidateCode().getImageCodeProperties().getLength();
        ...
        g.dispose();
        int expireIn = shieldSecurityProperties.getValidateCode().getImageCodeProperties().getExpireIn();
